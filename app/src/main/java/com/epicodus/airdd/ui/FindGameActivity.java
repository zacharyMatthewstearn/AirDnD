...
//        });
    ...
    private void getGames() {
        ...
        Game tempGame1 = new Game(tempUser1, true, "test_title_1", "test_description_1", "test_location_1", new java.util.Date());
        Game tempGame2 = new Game(tempUser2, true, "test_title_2", "test_description_2", "test_location_2", new java.util.Date());
        Game tempGame3 = new Game(tempUser3, true, "test_title_3", "test_description_3", "test_location_3", new java.util.Date());
